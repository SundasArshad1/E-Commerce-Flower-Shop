    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Anniversery<br></h2>
          <p data-aos="fade-up" data-aos-delay="100">Make Anniversery Events even more special with our premium boquet collection.</p>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="images/ani.png" class="img-fluid" alt="" style="border-radius:50%;" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
     ...
     <?php 
       ...
       try {
         ...
         if(isset($_POST["filter"]))
         {
           ...
           $sql = "SELECT Bouquet_Name, Product_No, Bouquet_Price, Bouquet_Img, Bouquet_Des FROM bouquet WHERE Bouquet_Category='Anniversery' AND Bouquet_Price BETWEEN $minPrice AND $maxPrice";
         }
         else
         {
         $sql="SELECT Bouquet_Name, Product_No,Bouquet_Price,Bouquet_Img,Bouquet_Des from bouquet Where Bouquet_Category='Anniversery'";
         }
         try {
           $rows = $conn->query( $sql );
