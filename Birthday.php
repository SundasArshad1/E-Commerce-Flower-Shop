    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Birthday<br></h2>
          <p data-aos="fade-up" data-aos-delay="100">Make Bithday Celebrations memorable with our classy bouquets</p>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="images/BD.png" class="img-fluid" alt="" style="border-radius:50%;" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
     ...
     <?php 
       ...
       try {
         ...
         if(isset($_POST["filter"]))
         {
           ...
           $sql = "SELECT Bouquet_Name, Product_No, Bouquet_Price, Bouquet_Img, Bouquet_Des FROM bouquet WHERE Bouquet_Category='Birthday' AND Bouquet_Price BETWEEN $minPrice AND $maxPrice";
         }
         else
         {
         $sql="SELECT Bouquet_Name, Product_No,Bouquet_Price,Bouquet_Img,Bouquet_Des from bouquet Where Bouquet_Category='Birthday'";
         }
         try {
           $rows = $conn->query( $sql );
...
foreach ($rows as $row) {
  ...
  echo "<hr width='90%' style='margin-left:20px'>";
  echo "<button type='buttn' class='buttn'><a href='Product.php?" . htmlspecialchars(http_build_query($data)) . "'>Order Now</a></button>";
  echo "</div>";
